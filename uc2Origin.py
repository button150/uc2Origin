...
for fname in list:
    ...
    ppath = OUTPUTPATH + art0 + ' - ' + art1 + '.png'
    ...
    try :
        ...
        if psize > 500000 :
            hppath = OUTPUTPATH + art0 + ' - ' + art1 + '_Huge' +'.png'
    ...
    if id :
        try :
            with open(OUTPUTPATH + art0 + ' - ' + art2 + '_' + id + '.' + mtype, 'wb') as fo:
                for i in b:
    ...
    if mtype == 'mp3' :
        audio = ID3(OUTPUTPATH + art0 + ' - ' + art2 + '_' + id + '.mp3')
        ...
        audio = FLAC(OUTPUTPATH + art0 + ' - ' + art2 + '_' + id + '.flac')
        ...
        with open(ppath,'rb') as rp1:
             picture.data = rp1.read()
